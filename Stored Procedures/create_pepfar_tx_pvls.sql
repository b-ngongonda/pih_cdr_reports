CREATE  PROCEDURE `create_pepfar_tx_pvls`(IN _startDate DATE,IN _endDate DATE, IN _location VARCHAR(255),IN _defaultCutOff INT,IN _birthDateDivider INT)
BEGIN

call create_age_groups();
call create_last_art_outcome_at_facility(_endDate,_location);

insert into pepfar_tx_pvls(sort_value, age_group,gender,tx_curr,due_for_vl,routine_samples_drawn,target_samples_drawn,
