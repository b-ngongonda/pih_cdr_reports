CREATE PROCEDURE `create_moh_tx_mmd_generic`(IN _startDate DATE,IN _endDate DATE, IN _location VARCHAR(255),IN _defaultCutOff INT,IN _birthDateDivider INT,
...
insert into moh_tx_mmd(age_group,gender,less_than_three_months,three_to_five_months,six_months_plus)
