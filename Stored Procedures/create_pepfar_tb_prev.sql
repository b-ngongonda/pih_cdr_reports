CREATE PROCEDURE `create_pepfar_tb_prev`(IN _endDate DATE, IN _location VARCHAR(255),IN _defaultCutOff INT,IN _birthDateDivider INT)
BEGIN

call create_age_groups();
call create_last_art_outcome_at_facility(_endDate,_location);
call create_hiv_cohort(@startDate,_endDate,_location,_birthDateDivider);

insert into pepfar_tb_prev(sort_value,age_group,gender,new_start_three_hp,new_start_six_h,previous_start_three_hp,previous_start_six_h,
