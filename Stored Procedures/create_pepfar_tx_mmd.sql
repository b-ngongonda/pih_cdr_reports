CREATE PROCEDURE `create_pepfar_tx_mmd`(IN _endDate DATE, IN _location VARCHAR(255),IN _defaultCutOff INT,IN _birthDateDivider INT)
BEGIN

call create_age_groups();
call create_last_art_outcome_at_facility(_endDate,_location);

insert into pepfar_tx_mmd(sort_value,age_group,gender,less_than_three_months,three_to_five_months,six_months_plus)
